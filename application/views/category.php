...
<div class="container">
    <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Search According to your selected category</span>
            <h2 class="mb-4">Category Result</h2>
        </div>
    </div>
</div>
...
<div class="container text-center mt-5">
 ...
 <div class="col-md-12">
                <div class="category-item">
                    <?php if (isset($specificategoryname)) : ?>
                    <a href="" style="color: #00be62;">Selected: <?= $specificategoryname->sitecategoryname ?></a>
                     <?php endif; ?>
                </div>
            </div>
