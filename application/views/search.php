            ...
            <div class="col-md-4">
                <div class="services-wrap ftco-animate">
                    ...
                    <div class="text">
                        ...
                        <a href="<?php echo $row->sitelink ?>" target="__blank" class="btn-custom">Click Here</a>
                    </div>
                </div>
            </div>
			<?php } ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        <div class="img" style="background-image: url(images/bg_2.jpg);">
                            ...
                            <h2>SORRY THE SITE YOU ARE LOOKING IS NOT FOUND</h2>
                            <p>Maybe you entered the wrong name please check again</p>
                            <p class="mb-0"><a href="sitelistpages" class="btn btn-primary px-4 py-3">Sitelists</a></p>
                        </div>
                    </div>
                </div>
            </div>
